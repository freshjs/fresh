 ...
 */
function _default(n1, n2) {
  // Get the value type
  var type = Object.prototype.toString.call(n1); // If the two objects are not the same type, return false

  if (type !== Object.prototype.toString.call(n2)) return false; // If items are not an object or array, return false
  ...
  if (len1 !== len2) return false; // Compare two items
  ...
  var compare = function compare(item1, item2) {
    ...
    if (['[object Array]', '[object Object]'].indexOf(itemType) >= 0) {
      ...
      if (itemType !== Object.prototype.toString.call(item2)) return false; // If it's a function, convert to a string and compare
